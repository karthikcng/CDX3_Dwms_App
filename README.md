...
Run `npm start` for a dev server. Test Changes. It particularly Navigate to this url `http://localhost:8093/`. The app will automatically reload if you change any of the source files.
